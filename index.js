...
Используя бот *Technocolor Academy*, вы соглашаетесь со следующим:

1️⃣ Материалы бота носят обучающий и информационный характер  
2️⃣ Ответственность за применение информации лежит на пользователе  
3️⃣ Все материалы являются интеллектуальной собственностью проекта  
4️⃣ Запрещено копирование и распространение без разрешения  
5️⃣ Администрация вправе изменять программу обучения  
